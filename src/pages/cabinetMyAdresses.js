            ...
            <div className=" space-y-2 rounded-lg shadow-lg  h-[564px]">
                ...
                <div className="flex space-x-[24px]">
                    ...
                    <div className="mr-[196px] space-x-2   border  rounded-[4px] border-[#E7E7E7] w-[360px] h-[204px]">
                        <div className="komunalka ml-[16px] mt-[16px] space-x-1">
                            <ul>
                                <li className="flex">
                                    ...
                                    <p className="text-[16px]">Назва адреси</p>
                                </li>
                                <li className="mt-[8px]">
                        ...
                        <NavLink to="/counters" className="py-2.5 px-5 mr-2 mb-2 text-[16px] font-medium rounded-[4px] w-full text-black_figma bg-white_figma border border-yellow_figma">
                            Перейти
                        </NavLink>
                        </div>
                    </div>
