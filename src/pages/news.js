        ...
        return (
            <>
                ...
                <div className="w-[956px] mx-auto">
                    <p className="mt-4 font-light">Лічильники – це незамінна частина нашого повсякденного життя, забезпечуючи облік
                        ...
                        <ul className="list-decimal px-4">
                            ...
                            <p className="font-light">Перший крок до успішного обліку показань лічильника – це встановити регулярний час для їх запису.
                            ...
                            <p className="font-light">Під час запису показань лічильника завжди прагнете максимальної точності.
                            ...
                            <p className="font-light">Залежно від типу лічильника, можливо, буде потрібно округлення.
                            ...
                            <p className="font-light">Перед записом показань лічильника важливо перевірити,
                            ...
                            <p className="font-light">Зберігайте докази ваших записів, як-от фотографії або нотатки.
                            ...
                            <p className="font-light">Багато постачальників послуг надають можливість надсилати
                            ...
                            <p className="font-light">Якщо ви передаєте показання лічильника особисто або по телефону,
                            ...
                            <p className="font-light">Надайте показання лічильника у встановлений термін.
                                Це дозволить уникнути штрафів чи проблем із виставленням рахунків.</p>
                            <li className="font-medium">Автоматизація процесу</li>
                            <p className="font-light">Якщо це можливо, розгляньте варіант автоматизації процесу
                            ...
                            <p className="font-light">Не соромтеся звертатися до постачальника послуг із запитаннями або проблемами,
