    ...
    return (
        <div className="w-[50%] mx-auto">
            ...
            <ul className="grid grid-flow-row grid-cols-3 gap-10 py-4 text-[18px]">
                <li><h2>Телефон</h2></li>
                <li><h2>Email</h2></li>
                <li><h2>Соціальні мережі</h2></li>
            </ul>
            <div className="text-sm grid grid-flow-row grid-cols-3 gap-10">
                <div>
                ...
                <div className="flex space-x-8 text-sm">
                    ...
                    <a href="https://web.telegram.org/" className="text-gray-500 hover:text-gray-900">
                    ...
                    <a href="https://www.viber.com/" className="text-gray-500 hover:text-gray-900">
